...
response = WS.sendRequest(findTestObject('DummyEmp/CreateandgetEmp', ['EmpName':GlobalVariable.EmpName , 'sal':salary,"age":age]))
...
WebUI.callTestCase(findTestCase('DummyEmps/GetEmp-single'), [:], FailureHandling.STOP_ON_FAILURE)
